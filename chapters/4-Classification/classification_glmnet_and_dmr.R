...
#Import distrom library to perform dmr
library(distrom)

#To find the number of available cores to use for your computer
available_cores <- detectCores()
available_cores

#Use available cores to make local cluster on your computer to use parallel computing
